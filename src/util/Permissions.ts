...
class Permissions extends BitField<PermissionsString, bigint> {
  public static override FLAGS = FLAGS;
  public static ALL = Object.values(FLAGS).reduce((all, p) => all | p, 0n);
  public static DEFAULT = BigInt(104324673);
  public static STAGE_MODERATOR = FLAGS.MANAGE_CHANNELS | FLAGS.MUTE_MEMBERS | FLAGS.MOVE_MEMBERS;
  public static override defaultBit = BigInt(0);
  /**
