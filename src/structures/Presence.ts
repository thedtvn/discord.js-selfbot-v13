...
class Presence extends Base {
  ...
  public activities: Array<Activity | CustomStatus | RichPresence | SpotifyRPC>;
  public clientStatus: { web?: string; mobile?: string; desktop?: string } | null;
...
class RichPresence extends Activity {
   ...
   */
  static async getExternal(client: any, applicationId: any, ...images: any[]): Promise<any> {
