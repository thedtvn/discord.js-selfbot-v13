...
import { VoiceBasedChannelTypes } from '../util/Constants';
...
class GuildChannel extends Channel {
  ...
  constructor(guild: any, data: any, client: any, immediatePatch: boolean = true) {
   ...
   */
  permissionsFor(memberOrRole: any, checkAdmin: boolean = true): any {
  ...
  overwritesFor(member: any, verified: boolean = false, roles: any = null): any {
   ...
   */
  async lockPermissions(): Promise<any> {
   ...
   *   .catch(console.error);
   */
  setParent(channel: any, { lockPermissions = true, reason }: { lockPermissions?: boolean; reason?: string } = {}): any {
    return this.edit(
      {
        parent: channel ?? null,
        lockPermissions,
