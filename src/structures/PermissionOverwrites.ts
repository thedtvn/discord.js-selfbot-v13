...
class PermissionOverwrites extends Base {
   ...
   *   .catch(console.error);
   */
  async edit(options: any, reason?: string): Promise<this> {
  ...
  toJSON(): { id: Snowflake; type: any; allow: Readonly<Permissions>; deny: Readonly<Permissions> } {
    return {
      id: this.id,
   ...
   */
  static resolveOverwriteOptions(options: any, { allow, deny }: { allow?: any; deny?: any } = {}): { allow: Permissions; deny: Permissions } {
   ...
   */
  static resolve(overwrite: any, guild?: any): { id: string; type: any; allow: any; deny: any } {
