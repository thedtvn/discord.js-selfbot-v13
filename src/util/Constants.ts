...
import { Error, RangeError, TypeError } from '../errors';
...
export const UserAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9210 Chrome/134.0.6998.205 Electron/35.3.0 Safari/537.36';
 ...
 */
export const PartialTypes = keyMirror(['USER', 'CHANNEL', 'GUILD_MEMBER', 'MESSAGE', 'REACTION', 'GUILD_SCHEDULED_EVENT']);
 ...
 */
export const IntegrationExpireBehaviors = createEnum(['REMOVE_ROLE', 'KICK']);
 ...
 */
export const MessageReferenceTypes = createEnum([
  'DEFAULT', // 0
  'FORWARD',
]);
 ...
 */
export const ThreadChannelTypes = ['GUILD_NEWS_THREAD', 'GUILD_PUBLIC_THREAD', 'GUILD_PRIVATE_THREAD'];
 ...
 */
export const VoiceBasedChannelTypes = ['GUILD_VOICE', 'GUILD_STAGE_VOICE'];
 ...
 */
export const ExplicitContentFilterLevels = createEnum(['DISABLED', 'MEMBERS_WITHOUT_ROLES', 'ALL_MEMBERS']);
 ...
 */
export const VerificationLevels = createEnum(['NONE', 'LOW', 'MEDIUM', 'HIGH', 'VERY_HIGH']);
 ...
 */
export const DefaultMessageNotificationLevels = createEnum(['ALL_MESSAGES', 'ONLY_MENTIONS']);
 ...
 */
export const MembershipStates = createEnum([null, 'INVITED', 'ACCEPTED']);
 ...
 */
export const WebhookTypes = createEnum([null, 'Incoming', 'Channel Follower', 'Application']);
 ...
 */
export const StickerTypes = createEnum([null, 'STANDARD', 'GUILD']);
 ...
 */
export const StickerFormatTypes = createEnum([null, 'PNG', 'APNG', 'LOTTIE', 'GIF']);
 ...
 */
export const OverwriteTypes = createEnum(['role', 'member']);
 ...
 */
export const ApplicationCommandTypes = createEnum([null, 'CHAT_INPUT', 'USER', 'MESSAGE']);
 ...
 */
export const ApplicationCommandPermissionTypes = createEnum([null, 'ROLE', 'USER']);
 ...
 */
export const ApplicationRoleConnectionMetadataTypes = createEnum([
  null,
  'INTEGER_LESS_THAN_OR_EQUAL',
  'INTEGER_GREATER_THAN_OR_EQUAL',
  'INTEGER_EQUAL',
 ...
 */
export const AutoModerationRuleTriggerTypes = createEnum([null, 'KEYWORD', null, 'SPAM', 'KEYWORD_PRESET', 'MENTION_SPAM']);
 ...
 */
export const AutoModerationRuleKeywordPresetTypes = createEnum([null, 'PROFANITY', 'SEXUAL_CONTENT', 'SLURS']);
/**
 ...
 */
export const AutoModerationActionTypes = createEnum([null, 'BLOCK_MESSAGE', 'SEND_ALERT_MESSAGE', 'TIMEOUT']);
...
export const AutoModerationRuleEventTypes = createEnum([null, 'MESSAGE_SEND']);
/**
 ...
 */
export const InteractionResponseTypes = createEnum([
  null,
  'PONG',
  null,
  null,
 ...
 * @see {@link https://discord.com/developers/docs/interactions/message-components#component-object-component-types}
 */
export const SelectMenuComponentTypes = createEnum([
 ...
 */
export const MessageButtonStyles = createEnum([null, 'PRIMARY', 'SECONDARY', 'SUCCESS', 'DANGER', 'LINK']);
 ...
 */
export const MFALevels = createEnum(['NONE', 'ELEVATED']);
 ...
 */
export const NSFWLevels = createEnum(['DEFAULT', 'EXPLICIT', 'SAFE', 'AGE_RESTRICTED']);
 ...
 */
export const PrivacyLevels = createEnum([null, 'PUBLIC', 'GUILD_ONLY']);
 ...
 */
export const TextInputStyles = createEnum([null, 'SHORT', 'PARAGRAPH']);
 ...
 */
export const GuildScheduledEventPrivacyLevels = createEnum([null, null, 'GUILD_ONLY']);
 ...
 */
export const PremiumTiers = createEnum(['NONE', 'TIER_1', 'TIER_2', 'TIER_3']);
 ...
 */
export const GuildScheduledEventStatuses = createEnum([null, 'SCHEDULED', 'ACTIVE', 'COMPLETED', 'CANCELED']);
 ...
 */
export const GuildScheduledEventEntityTypes = createEnum([null, 'STAGE_INSTANCE', 'VOICE', 'EXTERNAL']);
 ...
 */
export const VideoQualityModes = createEnum([null, 'AUTO', 'FULL']);
 ...
 * @see {@link https://discord.com/developers/docs/resources/channel#channel-object-video-quality-modes}
 */
export const ReactionTypes = createEnum(['NORMAL', 'BURST']);
 ...
 */
export const SortOrderTypes = createEnum([null, 'LATEST_ACTIVITY', 'CREATION_DATE']);
 ...
 */
export const ForumLayoutTypes = createEnum(['NOT_SET', 'LIST_VIEW', 'GALLERY_VIEW']);
 ...
 */
export const PollLayoutTypes = createEnum([null, 'DEFAULT', 'IMAGE_ONLY_ANSWERS']);
...
export const RelationshipTypes = createEnum([
  'IGNORED',
  'FRIEND',
  'BLOCKED',
  'PENDING_INCOMING',
...
export const SeparatorSpacingSizes = createEnum([null, 'SMALL', 'LARGE']);
