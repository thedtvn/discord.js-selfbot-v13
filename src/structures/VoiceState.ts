...
class VoiceState extends Base {
   ...
   */
  setMute(mute: any = true, reason: any): any {
    if (!this.guild?.id) return null;
   ...
   * @returns {Promise<GuildMember>}
   */
  setDeaf(deaf: any = true, reason: any): any {
    if (!this.guild?.id) return null;
   ...
   */
  async setRequestToSpeak(request: any = true): Promise<any> {
   ...
   * @returns {Promise<void>}
   */
  async setSuppressed(suppressed: any = true): Promise<any> {
