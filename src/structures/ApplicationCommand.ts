...
import ApplicationCommandPermissionsManager from '../managers/ApplicationCommandPermissionsManager';
import { ApplicationCommandOptionTypes, ApplicationCommandTypes, ChannelTypes } from '../util/Constants';
...
class ApplicationCommand extends Base {
  ...
  public type: string;
  public name: string;
  public nameLocalizations: Record<string, string> | null;
  ...
  public defaultMemberPermissions: any | null;
   ...
   */
  setDefaultPermission(defaultPermission: boolean = true): Promise<ApplicationCommand> {
   ...
   * @returns {Promise<ApplicationCommand>}
   */
  setDMPermission(dmPermission: boolean = true): Promise<ApplicationCommand> {
   ...
   * @returns {boolean}
   */
  equals(command: any, enforceOptionOrder: boolean = false): boolean {
   ...
   * @returns {boolean}
   */
  static optionsEqual(existing: any[], options: any[], enforceOptionOrder: boolean = false): boolean {
   ...
   * @private
   */
  static _optionEquals(existing: any, option: any, enforceOptionOrder: boolean = false): boolean {
