...
import PremiumUsageFlags from '../util/PremiumUsageFlags';
import PurchasedFlags from '../util/PurchasedFlags';
...
class ClientUser extends User {
  ...
  public purchasedFlags: Readonly<any>;
  public premiumUsageFlags: Readonly<any>;
  public phone: string | null;
  public nsfwAllowed: boolean | null;
   ...
   */
  async edit(options: any = {}): Promise<ClientUser> {
   ...
   *   .catch(console.error);
   */
  async setAvatar(avatar: any): Promise<ClientUser> {
   ...
   * @returns {ClientPresence}
   */
  setAFK(afk: boolean = true, shardId?: number | number[]): any {
   ...
   *   .catch(console.error);
   */
  async setBanner(banner: any): Promise<ClientUser> {
   ...
   * @returns {Promise<ClientUser>}
   */
  setAccentColor(color: any = null): Promise<ClientUser> {
   ...
   * @returns {Promise<ClientUser>}
   */
  setAboutMe(bio: string | null = null): Promise<ClientUser> {
   ...
   */
  async setSamsungActivity(packageName: string, type: string = 'START'): Promise<ClientUser> {
