...
import { randomPorts } from '../util/Function';
import { StreamOutput, type UnixStream } from '../util/Socket';
...
class Recorder extends EventEmitter {
  ...
  async init(output: string | Writable): Promise<void> {
    await this.promise;
   ...
   */
  feed(
    payload: RtpPacket | string | Buffer,
    callback: (e: Error | null) => void = e => {
      if (e) {
