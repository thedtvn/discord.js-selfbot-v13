...
class Message extends Base {
  ...
  public activity: { partyId: string; type: number } | null;
  public flags: MessageFlags;
  public reference: any;
  public interaction: any;
  public messageSnapshots: Collection<string, Message>;
  public call: any;
   ...
   */
  async fetchReference(): Promise<any> {
   ...
   *   .catch(console.error);
   */
  async edit(options: any): Promise<Message> {
   ...
   *   .catch(console.error)
   */
  async pin(reason: any): Promise<any> {
    if (!this.channel) throw new Error('CHANNEL_NOT_CACHED');
   ...
   *   .catch(console.error)
   */
  async unpin(reason: any): Promise<any> {
    if (!this.channel) throw new Error('CHANNEL_NOT_CACHED');
   ...
   *   .catch(console.error);
   */
  async react(emoji: any, burst: boolean = false): Promise<any> {
    if (!this.channel) throw new Error('CHANNEL_NOT_CACHED');
   ...
   */
  async startThread(options: any = {}): Promise<any> {
    if (!this.channel) throw new Error('CHANNEL_NOT_CACHED');
   ...
   * @returns {Promise<Message>}
   */
  async fetch(force: any = true): Promise<any> {
    if (!this.channel) throw new Error('CHANNEL_NOT_CACHED');
   ...
   * @returns {Promise<Message>}
   */
  suppressEmbeds(suppress: any = true): any {
