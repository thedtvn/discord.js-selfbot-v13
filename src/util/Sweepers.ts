...
import { Events, ThreadChannelTypes, SweeperKeys } from './Constants';
...
class Sweepers {
  ...
  public intervals: Record<string, NodeJS.Timeout | null>;
   ...
   */
  sweepApplicationCommands(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepAutoModerationRules(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepBans(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepEmojis(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepInvites(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepGuildMembers(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepMessages(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepPresences(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepReactions(filter: (...args: unknown[]) => boolean) {
    if (typeof filter !== 'function') {
      throw new TypeError('INVALID_TYPE', 'filter', 'function');
    }
    let channels = 0;
   ...
   */
  sweepStageInstances(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepStickers(filter: (...args: unknown[]) => boolean) {
   ...
   */
  sweepThreadMembers(filter: (...args: unknown[]) => boolean) {
    if (typeof filter !== 'function') {
      throw new TypeError('INVALID_TYPE', 'filter', 'function');
    }
   ...
   */
  sweepThreads(filter: (...args: unknown[]) => boolean) {
    if (typeof filter !== 'function') {
      throw new TypeError('INVALID_TYPE', 'filter', 'function');
    }
   ...
   */
  sweepUsers(filter: (...args: unknown[]) => boolean) {
    if (typeof filter !== 'function') {
      throw new TypeError('INVALID_TYPE', 'filter', 'function');
    }
   ...
   */
  sweepVoiceStates(filter: (...args: unknown[]) => boolean) {
  ...
  static archivedThreadSweepFilter(lifetime = 14400) {
    return this.filterByLifetime({
      lifetime,
      getComparisonTimestamp: (e: { archiveTimestamp?: number }) => e.archiveTimestamp,
      excludeFromSweep: (e: { archived?: boolean }) => !e.archived,
    });
  }
  ...
  static expiredInviteSweepFilter(lifetime = 14400) {
    return this.filterByLifetime({
      lifetime,
      getComparisonTimestamp: (i: { expiresTimestamp?: number }) => i.expiresTimestamp,
    });
  }
  ...
  static outdatedMessageSweepFilter(lifetime = 3600) {
    return this.filterByLifetime({
      lifetime,
      getComparisonTimestamp: (m: { editedTimestamp?: number; createdTimestamp?: number }) =>
   ...
   * @private
   */
  _initInterval(intervalKey: string, sweepKey: string, opts: { interval: number; filter: () => unknown }) {
