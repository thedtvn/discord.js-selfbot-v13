...
class Guild extends AnonymousGuild {
  ...
  public premiumTier: string;
  public widgetEnabled: boolean | null;
  public widgetChannelId: string | null;
  public explicitContentFilter: string;
  public mfaLevel: string;
  public joinedTimestamp: number;
  public defaultMessageNotifications: string;
   ...
   *   .catch(console.error);
   */
  async fetchIntegrations(): Promise<Collection<string, any>> {
   ...
   *   .catch(console.error);
   */
  async fetchVanityData(): Promise<any> {
   ...
   *   .catch(console.error);
   */
  async fetchWidgetSettings(): Promise<{ enabled: boolean; channel: any }> {
   ...
   *   .catch(console.error);
   */
  async fetchAuditLogs({ before, after, limit, user, type }: { before?: any; after?: any; limit?: number; user?: any; type?: any } = {}): Promise<GuildAuditLogs> {
   ...
   * })
   */
  async editWelcomeScreen(data: any): Promise<WelcomeScreen> {
   ...
   * @returns {Promise<Guild>}
   */
  setPremiumProgressBarEnabled(enabled: boolean = true, reason?: string): Promise<Guild> {
   ...
   * @returns {Promise<Guild>}
   */
  async setWidgetSettings(settings: any, reason?: string): Promise<this> {
   ...
   * @returns {Promise<Guild>}
   */
  disableInvites(disabled: boolean = true): Promise<Guild> {
   ...
   * @returns {Promise<Guild>}
   */
  async setCommunity(stats: boolean = true, publicUpdatesChannel?: any, rulesChannel?: any, reason?: string): Promise<Guild> {
    if (stats) {
      // Check everyone role
   ...
   *   .catch(console.error);
   */
  async setVanityCode(code: string = ''): Promise<any> {
