...
class MessageMentions {
  ...
  public _members: Collection<string, any> | null;
  public _channels: Collection<string, any> | null;
  public _parsedUsers: Collection<string, any> | null;
  public crosspostedChannels: Collection<string, any>;
  ...
  get channels(): Collection<string, any> {
    ...
    let matches;
    while ((matches = (this.constructor as typeof MessageMentions).CHANNELS_PATTERN.exec(this._content)) !== null) {
  ...
  get parsedUsers(): Collection<string, any> {
    ...
    let matches;
    while ((matches = (this.constructor as typeof MessageMentions).USERS_PATTERN.exec(this._content)) !== null) {
   ...
   * @returns {boolean}
   */
  has(data: any, { ignoreDirect = false, ignoreRoles = false, ignoreRepliedUser = false, ignoreEveryone = false } = {}): boolean {
