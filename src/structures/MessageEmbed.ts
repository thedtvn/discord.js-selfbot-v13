...
class MessageEmbed {
   ...
   */
  constructor(data: any = {}, skipValidation: boolean = false) {
  ...
  setup(data: any, skipValidation: boolean): void {
    ...
    this.fields = [];
    if (data.fields) {
      this.fields = skipValidation ? data.fields.map(Util.cloneObject) : (this.constructor as typeof MessageEmbed).normalizeFields(data.fields);
    }
  ...
  addFields(...fields: any[]): this {
    this.fields.push(...(this.constructor as typeof MessageEmbed).normalizeFields(fields));
    return this;
  }
  ...
  spliceFields(index: number, deleteCount: number, ...fields: any[]): this {
    this.fields.splice(index, deleteCount, ...(this.constructor as typeof MessageEmbed).normalizeFields(...fields));
    return this;
  }
