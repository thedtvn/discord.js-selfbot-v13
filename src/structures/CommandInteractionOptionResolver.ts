...
class CommandInteractionOptionResolver {
   ...
   */
  getSubcommandGroup(required: boolean = true): string | null {
   ...
   */
  getUser(name: string, required: boolean = false): any {
   ...
   * The value of the option, or null if not set and not required.
   */
  getMember(name: string, required: boolean = false): any {
   ...
   * The value of the option, or null if not set and not required.
   */
  getMentionable(name: string, required: boolean = false): any {
   ...
   * The value of the option, or null if not set and not required.
   */
  getMessage(name: string, required: boolean = false): any {
   ...
   */
  getFocused(getFull: boolean = false): any {
   ...
   */
  getAttachment(name: string, required: boolean = false): any {
