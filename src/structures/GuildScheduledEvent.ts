...
class GuildScheduledEvent extends Base {
  ...
  public privacyLevel: string | null;
  public status: string | null;
  public entityType: string | null;
  public entityId: string | null;
  public userCount: number | null;
  public creator: any | null;
  public entityMetadata: { location: string | null } | null;
  public image: string | null;
  public recurrenceRule: any | null;
   ...
   * @returns {?string}
   */
  coverImageURL({ format, size }: { format?: string; size?: number } = {}): string | null {
   ...
   */
  fetch(force: boolean = true): Promise<GuildScheduledEvent> {
   ...
   */
  async createInviteURL(options?: any): Promise<string> {
