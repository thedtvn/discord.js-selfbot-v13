...
class DataResolver extends null {
  ...
  static resolveGuildTemplateCode(data: string): string {
    return this.resolveCode(
      data,
      (GuildTemplate as unknown as { GUILD_TEMPLATES_PATTERN: RegExp }).GUILD_TEMPLATES_PATTERN,
    );
  }
   ...
   */
  static async resolveImage(image: string | Buffer | stream.Readable | null): Promise<string | null> {
   ...
   */
  static async resolveFile(resource: string | Buffer | stream.Readable): Promise<Buffer | stream.Readable> {
   ...
   */
  static async resolveFileAsBuffer(resource: string | Buffer | stream.Readable): Promise<Buffer> {
