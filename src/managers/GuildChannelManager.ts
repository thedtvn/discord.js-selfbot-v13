...
type RawGuildChannelData = { id: Snowflake } & Record<string, unknown>;
 ...
 */
class GuildChannelManager extends CachedManager<Snowflake, GuildChannel, GuildChannelResolvable, RawGuildChannelData, [Guild]> {
  ...
  async setPosition(
    channel: GuildChannelResolvable,
    position: number,
    { relative, reason }: SetChannelPositionOptions = {},
