...
import { ChannelTypes, MessageComponentTypes } from '../util/Constants';
...
class MessageSelectMenu extends BaseMessageComponent {
   ...
   */
  static normalizeOption(option: any): { label: any; value: any; description: any; emoji: any; default: any } {
   ...
   * @returns {MessageSelectOption[]}
   */
  static normalizeOptions(...options: any[]): { label: any; value: any; description: any; emoji: any; default: any }[] {
